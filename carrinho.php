            ...
            <div class="card">
                <div class="card-body">
                    <ul class="list-group list-group-flush py-2">
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between align-items-center">
                                <span>Subtotal (<span class="qtd">1</span> item)</span>
                    ...
                    <form action="comprar.php" method="post">
                        <input type="hidden" name="cad_usuario_id" value="' . getUserInfo("id") . '">
                        <input type="hidden" name="cad_produto_id" value="' . $cad_produtos_id . '">
                        <input type="hidden" name="quantidade" class="qtd" value="1">
                        <div class="d-grid gap-2">
                            <input type="submit" class="p-1 bg-danger border-0 text-white" tabindex="-1" role="button" value="Finalizar">
                        </div>
                    </form>
                </div>
            </div>
